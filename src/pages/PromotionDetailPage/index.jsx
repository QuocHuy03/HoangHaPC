          ...
          <div className="row">
            <div className="col-8 art-detail-col-left">
              ...
              <p className="art-detail-author">
                Đăng trong <b>Tin Khuyến Mãi</b>
              </p>
              <div className="art-detail-content" id="js-find_toc">
                <p>
                  <strong>
                    Xây dựng bộ máy siêu chất tại&nbsp;
                    <span style={{ color: "#ff0000" }}>
                      <a
                        style={{ color: "#ff0000" }}
                        title="Hoàng Hà PC"
                        href="https://hoanghapc.vn/"
                      >
                        Hoàng Hà PC
                      </a>
                    </span>{" "}
                    từ các linh kiện TUF của Asus và nhận ngay quà khủng với
                    tổng trị giá lên tới 15 triệu đồng.
                  </strong>
                </p>
                <h2 style={{ textAlign: "center" }} id="khuyen-mai">
                  <span style={{ color: "#ff0000" }} id="khuyen-mai">
                    <strong id="khuyen-mai">KHUYẾN MẠI</strong>
                  </span>
                </h2>
                <h2
                  style={{ textAlign: "center" }}
                  id="build-pc-full-tuf-nhan-qua-cuc-chat"
                >
                  <span
                    style={{ color: "#ff0000" }}
                    id="build-pc-full-tuf-nhan-qua-cuc-chat"
                  >
                    <strong id="build-pc-full-tuf-nhan-qua-cuc-chat">
                      BUILD PC FULL TUF - NHẬN QUÀ CỰC CHẤT
                    </strong>
                  </span>
                </h2>
                  ...
                  <span style={{ color: "#ff0000" }}>
                    <strong>
                      <img
                        ...
                        src="https://i.imgur.com/TSeq0Pq.jpg"
                ...
                <p>
                  <strong>1. Thời gian khuyến mại:</strong>&nbsp;Từ{" "}
                  <strong>01/03/2023</strong>&nbsp;đến&nbsp;
                  <strong>30/04/2023&nbsp;</strong>hoặc cho đến khi hết quà
                </p>
                <p>
                  <strong>
                    2.&nbsp;Hạn chót đăng ký nhận quà:&nbsp;
                    <strong>05/05/2023</strong>
                  </strong>
                </p>
                <p>
                  <strong>3. Đối tượng hưởng khuyến mại:</strong>&nbsp;Người
                  dùng cuối
                </p>
                <p>
                  <strong>4. Nội dung khuyến mại:</strong>&nbsp;
                </p>
                <p>
                  <span
                  ...
                  <span style={{ fontFamily: "Arial, sans-serif" }}>
                    Mua Bo mạch chủ + Card đồ họa + Case + Nguồn + Tản + Màn
                    hình + Thiết bị ngoại vi router + Bàn phím + Tai nghe +
                    Chuột, tặng&nbsp;
                    <strong>
                      Giá đỡ card ROG HERCULX + Box SSD ASUS TUF Gaming A1 + áo
                      thun EVA +&nbsp; áo khoác ASUS TUF Gaming phiên bản giới
                      hạn + đồng hồ ASUS Vivowatch 5 (hoặc ghế Gaming ROG
                      Chariot Core tổng trị giá&nbsp;
                      <span style={{ color: "red", fontSize: "14pt" }}>
                        15,000,000đ
                      </span>
                    </strong>
                  </span>
                ...
                <p>
                  - Mua Bo mạch chủ + Card đồ họa + Case + Nguồn + Tản,
                  tặng&nbsp;
                  <strong>
                    Giá đỡ card ROG HERCULX +&nbsp; Box SSD ASUS TUF Gaming A1
                    tổng trị giá&nbsp;
                    <span style={{ color: "red", fontSize: "14pt" }}>
                      2,220,000đ
                    </span>
                ...
                <p>
                  - Mua Bo mach chủ + Card đồ họa + Màn hình, tặng&nbsp;
                  <strong>
                    Giá đỡ card ROG HERCULX +&nbsp; Áo thun EVA phiên bản giới
                    hạn tổng trị giá&nbsp;
                    <span style={{ color: "red", fontSize: "14pt" }}>
                      2,000,000đ
                    </span>
                ...
                <p>
                  - Mua Bo mach chủ + Card đồ họa + Thiết bị ngoại vi router,
                  tặng&nbsp;
                  <strong>
                    Giá đỡ card ROG HERCULX +&nbsp; Áo khoác ASUS TUF Gaming
                    phiên bản giới hạn tổng trị giá&nbsp;
                    <span style={{ color: "red", fontSize: "14pt" }}>
                      2,000,000đ
                    </span>
                  </strong>
                ...
                <p>
                  - Mua Bo mach chủ + Card đồ họa + Bàn phím + Tai nghe + Chuột,
                  tặng&nbsp;
                  <strong>
                    Giá đỡ card ROG HERCULX +&nbsp; Áo khoác ASUS TUF Gaming
                    phiên bản giới hạn tổng trị giá&nbsp;
                ...
                <p>
                  - Mua Bo mạch chủ + Card đồ họa, tặng&nbsp;
                  <strong>
                    Giá đỡ card ROG HERCULX trị giá&nbsp;
                    <span style={{ color: "red", fontSize: "14pt" }}>
                      1,070,000đ
                    </span>
                  </strong>
                  ...
                  <strong>
                    <span style={{ color: "red", fontSize: "14pt" }}>
                      <img
                        ...
                        src="https://i.imgur.com/zxwUcyk.jpg"
                        alt="BUILD PC FULL TUF - NHẬN QUÀ CỰC CHẤT"
                        width={660}
                        height={238}
                      />
                ...
                <p>
                  <img
                    ...
                    src="https://i.imgur.com/3ird2wq.jpg"
                    alt="BUILD PC FULL TUF - NHẬN QUÀ CỰC CHẤT"
                    width={660}
                    height={1023}
                  />
                ...
                <p>
                  <strong>5.&nbsp;Cách thức nhận quà:</strong>
                </p>
                <p>
                  Click vào nút “Đăng kí” trên website sự kiện{" "}
                  <span style={{ color: "#0000ff" }}>
                    <a
                      style={{ color: "#0000ff" }}
                      href="https://www.asus.com/vn/events/infoM/activity_TUF/"
                    >
                      https://www.asus.com/vn/events/
                    </a>
                  </span>
                </p>
                <p>
                  Lưu ý: Trong trường hợp không thể đăng ký trên hệ thống, quý
                  khách hàng vui lòng gửi thông tin nhận quà như bên dưới về địa
                  chỉ Email:{" "}
                  <span style={{ color: "#0000ff" }}>
                    <a
                      style={{ color: "#0000ff" }}
                      href="mailto:dangkyasus@gmail.com"
                    >
                      dangkyasus@gmail.com
                    </a>
                  </span>
                  &nbsp;với tiêu đề: “[Khuyen mai] TUF Gaming”
                </p>
                <p>
                  - Đính kèm hình ảnh hóa đơn mua hàng, phiếu thu, phiếu xuất
                  kho có dấu xác nhận của cửa hàng, thể hiện rõ tên sản phẩm và
                  ngày mua hàng trong thời gian chương trình diễn ra.
                </p>
                ...
                <p>
                  Hình chụp số S/N trên sản phẩm phải chụp kèm với hoá đơn, chỉ
                  chấp nhận hình chụp số S/N trên sản phẩm, số S/N trên hộp
                  không có hiệu lực.
                </p>
                <p>
                  <strong>6. Các lưu ý khác:</strong>
                </p>
                <p>
                  - ASUS sẽ kiểm tra và liên hệ gửi quà tới bạn trong 20 ngày
                  làm việc (ngoại trừ thứ 7 &amp; Chủ nhật)
                </p>
                <p>
                  - Chương trình không áp dụng đồng thời với các chương trình
                  khuyến mãi khác.
                </p>
                <p>
                  - Quà tặng không có giá trị quy đổi thành tiền mặt hoặc các
                  giá trị khác tương đương.
                </p>
                <p>
                  - Hóa đơn/ phiếu thu/ phiếu xuất kho phải có con dấu của cửa
                  hàng bán lẻ.
                </p>
                <p>- Dung lượng hình ảnh hóa đơn tải lên hệ thống &lt;1Mb.</p>
                <p>
                  - Trong trường hợp cần thiết nhằm bảo đảm quyền lợi khách
                  hàng, phía ASUS sẽ cần thêm những thông tin khác để xác định
                  khách mua hàng là chính xác như: hóa đơn đỏ, giấy tờ tùy thân
                  có ảnh đại diện...
                </p>
                <p>
                  - Mọi góp ý hay thắc mắc khác về chương trình, xin vui lòng
                  post tại <strong>Hội linh kiện PC ASUS ROG Việt Nam.</strong>
                </p>
              </div>
                ...
                <div id="js-first-paragraph">
                  <div className="archor-list-group" id="js-archor-list">
                    <ol>
                      ...
                      <li>
                        <a href="#build-pc-full-tuf-nhan-qua-cuc-chat">
                          <span style={{ color: "#ff0000" }}>
                            <strong>
                              BUILD PC FULL TUF - NHẬN QUÀ CỰC CHẤT
                            </strong>
              ...
              <div className="d-flex flex-wrap">
                  ...
                  <div className="art-text">
                    ...
                    <div className="art-hover">
                      <div className="art-summary">
                        ...
                        series và mainboard ASUS tuỳ theo mã sản phẩm sẽ nhận
                        được quà tặng là RAM Kingston
                      </div>
                      <a
                        href="/build-may-khung-nhan-ram-chat"
                        className="art-btn"
                ...
                <div className="art-item">
                  ...
                  <div className="art-text">
                    ...
                    <div className="art-hover">
                      <div className="art-summary">
                        Hoàng Hà PC triển khai chương trình khuyến mại đặc biệt,
                        với nhiều quà tặng giá trị dành cho Quý Khách hàng Doanh
                        nghiệp khi xây dựng hệ thống máy tính cho văn phòng tại
                        Hoàng Hà PC trong năm 2023.
                      </div>
                      <a
                        href="/uu-dai-danh-cho-khach-hang-doanh-nghiep"
                        className="art-btn"
                ...
                <div className="art-item">
                  ...
                  <div className="art-text">
                    ...
                    <div className="art-hover">
                      <div className="art-summary">
                        Sở hữu con chíp mạnh mẽ thế hệ mới của AMD tại Hoàng Hà
                        PC và nhận ngay code game STAR WARS Jedi: Survivor™ cực
                        hot hiện nay.
                      </div>
                      <a
                        href="/mua-cpu-amd-tang-code-game-star-wars-jedi-survivor"
